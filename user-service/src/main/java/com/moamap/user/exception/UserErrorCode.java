...
public enum UserErrorCode implements ErrorCode {
    ...
    INVALID_FILE_TYPE("USER_004", "허용되지 않은 파일 형식입니다.", 400),
    FILE_SIZE_EXCEEDED("USER_005", "파일 크기가 허용치를 초과했습니다.", 400),
    STORAGE_NOT_CONFIGURED("USER_006", "이미지 업로드를 사용할 수 없습니다.", 503);
