 ...
 * 다만 초대로 들어간 프라이빗 지도는 신호를 약하게 본다. {@code type}은 그 판단(UserInterestProfiler.signalWeight)에 쓰인다.
 */
public record JoinedMap(List<String> tags, MapType type, MapRole role, LocalDateTime joinedAt) {
}
